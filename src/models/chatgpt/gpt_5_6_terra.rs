//! Complete canonical model facts for ChatGPT GPT-5.6 Terra (`chatgpt/gpt-5.6-terra`).
...
pub(crate) const ID: &str = "chatgpt/gpt-5.6-terra";

/// Builds the ChatGPT GPT-5.6 Terra profile with its subscription context limits.
