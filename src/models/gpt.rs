...
fn gpt_5_6_sol() -> ModelConfig {
    ModelConfig {
        id: GPT_5_6_SOL_ID.to_owned(),
...
fn gpt_5_3_codex_spark() -> ModelConfig {
    ModelConfig {
