...
pub use capability::{
    ...
    ChatCompletionsProfile, ChatFileInputProfile, ChatMediaProfile, DashScopeImagesCapabilities,
    DashScopePromptExtendMode, EmbeddingDimensionDomain, EmbeddingEncoding, EmbeddingInputForm,
    EmbeddingsCapabilities, ExecutableAudioProfile, ExecutableResponsesState, FileDetail,
    FileDetailProfile, FileInlineEncoding, FileMediaType, FunctionToolCapabilities,
    ...
    ImagesGenerationsCapabilities, ImagesOutputFormat, ImagesResponseFormat, ImagesSizeDomain,
