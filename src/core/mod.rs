...
pub use capability::{
    ...
    DashScopePromptExtendMode, EmbeddingDimensionDomain, EmbeddingEncoding,
    EmbeddingEncodingPolicy, EmbeddingInputForm, EmbeddingsCapabilities, ExecutableAudioProfile,
    ...
    ImageMediaType, ImageSourceCapabilities, ImagesGenerationsCapabilities, ImagesOutputFormat,
    ImagesResponseFormat, ImagesSizeDomain, InlineAudioInputLimits, InlineAudioInputProfile,
