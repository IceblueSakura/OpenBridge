//! Static Alibaba Cloud Model Studio Provider contract and OpenAI-compatible Chat profile.
...
/// Basic Model Studio Chat Completions ceiling confirmed independently of any model-specific target.
...
/// OpenAI-compatible Chat wire profile used by the Model Studio Beijing endpoint.
