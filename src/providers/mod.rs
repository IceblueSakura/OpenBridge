//! OpenBridge 编译进二进制的 Provider 与 deployment 目录。
//!
...
pub fn compiled_definition() -> RegistryDefinition {
    ...
    RegistryDefinition {
        ...
        providers: vec![openai.provider, meituan.provider],
        deployments: [openai.deployments, meituan.deployments].concat(),
        aliases: vec![
            AliasDefinition {
            ...
            AliasDefinition {
                ...
                candidates: vec!["meituan-longcat-2".to_owned()],
            },
        ],
    }
}
