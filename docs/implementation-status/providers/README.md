...
| Provider | 状态页 | 当前固定 Target | 最近真实探测 |
|---|---|---:|---|
| Alibaba Cloud Model Studio | [Bailian 状态](bailian.md) | 11 | 2026-08-11 |
| DeepSeek | [DeepSeek 状态](deepseek.md) | 2 | 2026-08-11 |
| LongCat | [LongCat 2.0 状态](longcat.md) | 1 | 2026-08-08（high）；none 尚未真实复测 |
| Kimi CN | [Kimi K3 状态](kimi-cn.md) | 1 | 2026-08-09 |
| Xiaomi MiMo | [MiMo 多模态与工具调用状态](mimo.md) | 6 | 2026-08-11 |
