...
[普通参数上游兼容规则](../gateway-api/parameter-compat.md)显式列出的字段，具体候选可以在 egress 前忽略，因而不承诺
...
[图片](../extended-capabilities/image-input.md)、[文件](../extended-capabilities/file-input.md)和[音频](../extended-capabilities/audio.md)功能页拥有。
