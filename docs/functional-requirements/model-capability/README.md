...
retry、fallback 与 cooldown 见[路由与 Provider 韧性](../routing-resilience/README.md)；实现与验证事实见
...
只有[普通参数上游兼容规则](../gateway-api/parameter-compatibility.md)中的闭合字段可以在选中 Upstream API 的
