...
| 工具                 | `tools`、`tool_choice`、`parallel_tool_calls`                               | 见 [Function tools](function-tools.md)                            |
| 结构化输出           | `response_format`                                                           | 见 [Structured output](structured-output.md)                      |
| Streaming            | `stream`、`stream_options`                                                  | 见 [Chat SSE](streaming.md)                                       |
