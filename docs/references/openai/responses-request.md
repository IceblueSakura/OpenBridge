...
| 工具                 | `tools`、`tool_choice`、`parallel_tool_calls`、`max_tool_calls`        | [Function tools](responses-function-tools.md)                           |
| 结构化输出           | `text.format`                                                           | [Structured output](responses-structured-output.md)                     |
| Streaming            | `stream`                                                                | [Responses SSE](responses-streaming.md)                                 |
| Continuation/state   | `conversation`、`previous_response_id`、`store`                         | [State ownership](responses-state.md)                                   |
| Background/resources | `background`                                                            | [Resource lifecycle](responses-resource-lifecycle.md)                   |
