...
工具 response 的完整关联规则见 [Function tools](chat-completions-function-tools.md)，音频 response 形状见
...
- 本文不定义 data-only SSE chunk；见 [Chat SSE](chat-completions-streaming.md)；
