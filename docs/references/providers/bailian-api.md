...
- Last reverified：各来源原始复核为 2026-08-08 至 2026-08-22；2026-08-24 仅整理本地文档，未刷新外部来源。
...
OpenAI-compatible base URL 使用 `compatible-mode/v1`。北京、新加坡、法兰克福和东京可使用业务空间专属域名；美国使用区域公共域名。模型、endpoint、API key 与 region 必须匹配，具体域名以官方地域文档为准。
