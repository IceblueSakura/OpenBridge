...
| Responses HTTP/WS Header 与执行元数据 | [Header 行为基线](codex-responses-http-header-behavior.md) | `44b857c00e5803adedbc5b2e94c4a33574a157fe`，复核 2026-09-22 |
...
这些文档证明固定 Codex client 快照如何消费协议、管理 credential 与投影私有执行元数据，不定义完整 OpenAI server 规范，也不公开保证第三方复用
