...
[旧 ADR-0001（固定归档）](https://github.com/IceblueSakura/OpenBridge/blob/4f13ecefa21265a6ec5aa967278e81f03039f585/docs/decisions/0001-generation-ir-authority.md) 已决定 IR 是 encode 权威，源保留只能作为受约束的保留元数据；本页不复制其内容，只保留指针。
