...
下面记录外部项目本地 checkout 最近一次按主题复核的位置，不覆盖各文档各自固定的原始 commit；未列为已复核的主题仍以对应文档
中的快照为准：

| 项目        | 分支与提交                                                              | 已复核主题                                                     |
|-------------|-------------------------------------------------------------------------|----------------------------------------------------------------|
| Codex       | `main` @ `ee0247f95a6fe2b094ba2253d82cae2a2b4c2dff`                     | device/browser auth、refresh、Responses SSE/tool tests         |
| Hermes      | `main` @ `a31be48030f60383bf4c1d96ba46bd4b48430218`                     | Chat/Responses mode、上游请求字段与 stream；credential lifecycle 仍以专项文档快照为准 |
