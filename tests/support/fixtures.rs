...
pub fn capabilities() -> ApiCapabilities {
    ApiCapabilities::from_operations([
        ProviderOperationCapabilities::ChatCompletions(&ProviderChatCompletionsCapabilities {
            ...
            stream_usage: false,
            function_tools: None,
            media: openbridge::core::ChatMediaProfile {
                image: None,
                audio: None,
                file: None,
            },
        ...
        ProviderOperationCapabilities::Responses(&ProviderResponsesCapabilities {
            ...
            function_tools: None,
            media: openbridge::core::ResponsesMediaProfile {
                image: None,
                file: None,
            },
            structured_outputs: None,
                ...
                UpstreamApiConfig {
                    ...
                    capabilities: UpstreamApiCapabilities::ChatCompletions(
                        capabilities()
                            ...
                            .to_executable(openbridge::core::ChatMediaProfile::default()),
                    ),
                    ...
                    capabilities: UpstreamApiCapabilities::Responses(
                        capabilities()
                            ...
                            .to_executable(
                                ...
                                openbridge::core::ResponsesMediaProfile::default(),
                            ),
                    ),
                    streaming_policy: openbridge::registry::UpstreamStreamingPolicy::Optional,
                },
