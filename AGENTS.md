...
- `pipeline/analysis.rs` is a facade. Generation and Embeddings analyzers extract request facts only; they must not
  resolve registry entities or select Routes.
